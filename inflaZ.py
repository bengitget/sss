...
def inflaZ(data, sub_date=[], transformation=0):
    ...
    for i in range(1,n+1):
        if h[i]=='na':
            ...
            if new_date in new_date1:
                new_date=new_date+delay/2  
#            else: 
#                new_date=new_date
            i=+1
            ...
            new_date1.append(d)
    g=pd.DataFrame(new_date1).duplicated() 
    for i in range(1,n):
       if g[i]==True:
           new_date1[i]=new_date1[i]+timedelta(1)
